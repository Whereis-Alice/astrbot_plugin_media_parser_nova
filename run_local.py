...
try:
    ...
    from nova_core.parser.utils import format_duration_ms
    from nova_core.downloader import DownloadManager, create_public_only_connector
    from nova_core.downloader.utils import check_cache_dir_available
    from nova_core.parser.platform.base import BaseVideoParser
...
from nova_core.logger import logger  # noqa: E402

LOCAL_MEDIA_DIR = Config.build_cache_dir(_project_root)

PARSER_DISCOVERY_PACKAGE = "nova_core.parser.platform"
